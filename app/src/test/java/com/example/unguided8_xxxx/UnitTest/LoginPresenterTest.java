...
public class LoginPresenterTest {
    ...
    public void shouldStartMainActivityWhenNimAndPasswordAreCorrect() throws Exception {
        ...
        when(service.getValid(view, view.getNim(), view.getPassword())).thenReturn(true);
        System.out.println("Hasil : "+service.getValid(view,view.getNim(), view.getPassword()));
    ...
    public void shouldShowLoginErrorWhenNimAndPasswordAreInvalid() throws Exception {
        ...
        when(service.getValid(view, view.getNim(), view.getPassword())).thenReturn(false);
        System.out.println("Hasil : "+service.getValid(view,view.getNim(), view.getPassword()));
